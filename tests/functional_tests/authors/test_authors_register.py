...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def test_empty_first_name_error_message(self):
        def callback(form):
            first_name_field = self.get_by_placeholder(form, 'Ex.: James')
    ...
    def test_empty_last_name_error_message(self):
        def callback(form):
            last_name_field = self.get_by_placeholder(form, 'Ex.: Bond')
    ...
    def test_password_do_not_match(self):
        def callback(form):
            password_field = self.get_by_placeholder(form, 'Type your password here') 
            password2_field = self.get_by_placeholder(form, 'Repeat your password') 
            password_field.send_keys('P@ssw0rd')
            password2_field.send_keys('P@ssw0rd_Dif')
    ...
    def test_user_valid_data_register_successfully(self):
        ...
        self.get_by_placeholder(form, 'Ex.: James').send_keys('First Name')
        self.get_by_placeholder(form, 'Ex.: Bond').send_keys('Last Name')
        ...
        self.get_by_placeholder(form, 'Type your password here').send_keys('P@ssw0rd')
